...
import { getMerchandiseProducts } from "@/lib/store-data"
import { ShoppingBag } from "lucide-react"

export const metadata = {
  title: "Merchandising | Tienda Lis Samarah",
  description: "Productos exclusivos inspirados en las obras de Lis Samarah",
}

export default function MerchandisePage() {
  const merchandise = getMerchandiseProducts()
      ...
      <section className="relative w-full py-16 bg-gradient-to-r from-rose-900 to-rose-700">
        <div className="container mx-auto px-4 h-full flex items-center justify-center">
          <div className="text-center z-10 space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold text-white">Merchandising</h1>
            <p className="text-xl text-rose-100 max-w-2xl mx-auto">
              Productos exclusivos inspirados en las obras de Lis Samarah
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          {merchandise.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-xl text-gray-600">No hay productos de merchandising disponibles en este momento.</p>
              <Link
                href="/store"
